...
export const DIRECTION_EAST: Direction = [0, 1];
export const DIRECTION_WEST: Direction = [0, -1];
export const DIRECTION_NORTH: Direction = [1, 0];
export const DIRECTION_SOUTH: Direction = [-1, 0];
